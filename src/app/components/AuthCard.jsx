  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-[420px] px-4">
        {sideElement && (
          <div className="hidden md:block pointer-events-none md:absolute md:-right-[140px] md:bottom-[20px] md:z-20 transform md:-rotate-[3deg] origin-bottom transition-all duration-300">
            {sideElement}
          </div>
        )}
