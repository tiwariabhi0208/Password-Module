...
export function Footer({ onOpenHelpDesk }) {
  return (
    <footer
      className="w-full py-3.5 md:py-5 px-4 md:pl-6 md:pr-8 border-t text-white shadow-inner flex items-center mb-16 md:mb-0"
      style={{
    ...
    >
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-3.5 md:gap-6 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
          ...
          <p className="hidden md:block text-[11.5px] text-white/70 leading-normal font-semibold pl-0 md:pl-8">
            21, Barsapara Road, Binova Nagar, Guwahati - 781018
          </p>
        </div>

        {/* Middle Column: Centered Compliance Links */}
        <div className="flex flex-wrap justify-center gap-x-4 md:gap-x-5 gap-y-1.5">
          <a href="#" className="text-xs md:text-sm font-bold transition-colors hover:underline text-white/80 hover:text-white">
            Privacy Policy
          </a>
          <a href="#" className="text-xs md:text-sm font-bold transition-colors hover:underline text-white/80 hover:text-white">
            Terms of Use
          ...
          <button 
            ...
            className="text-xs md:text-sm font-bold transition-colors hover:underline text-white/80 hover:text-white cursor-pointer bg-transparent border-0 p-0 m-0 leading-normal"
          >
            Help Desk
          </button>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right gap-0.5">
          <p className="hidden md:block text-[10.5px] text-white/50 leading-normal max-w-[320px] font-semibold">
